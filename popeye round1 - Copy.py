...
url="http://192.168.43.24:8080/shot.jpg"
...
##    mask = mask0+mask1
    ...
    mask=cv2.inRange(img_hsv,lower_blue,upper_blue)#HSV VAUES WILL BE DIFFERENT
    ...
    for i in contours:
        ...
        print("coordinates in pixels",cx,cy)
        print("radius in cm",dist_calc(cx,cy,centerx,centery)*factor)
    #else:
    #    pass
